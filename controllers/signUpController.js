   ...
   try {
    ...
    if (newUser.rows.length < 1) {
     return ResHdlr.srvErr(
      res,
      "We cannot create a new account at this moment. More than likely there is an important security update on our servers rightnow. Please try tocreate a new account later and if the issue persists, contact thedeveloper at"
     );
    }
    ResHdlr.sucCreate(
     res,
