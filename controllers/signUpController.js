  ...
  try {
   ...
   `,
      ...
      if (existingUser.rows.length > 0) {
        return ResHdlr.badReq(
          res,
          "A user with this email already exists. Are you trying to login? If you have an account already and have forgotten your credentials please click the forgot credentials link below"
        );
      }
